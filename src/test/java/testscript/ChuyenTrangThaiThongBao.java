...
@Feature("Chuyển trạng thái thông báo")
public class ChuyenTrangThaiThongBao extends BaseTest {
    ...
    public void testScript11(String user, String pass) {
        try {
            ...
            if(!user.equals(readJson("$.acc.admin[0].user"))){
                Allure.step("6. Nếu không phải acc Admin thì Đăng xuất không thì chuyển tới Bước 9");
                ql.logout();
    ...
    public void testScript13() throws IOException {
        try{
            ...
            Allure.step("3. Click vào xem chi tiết thông báo đó");
            sleep(1000);
